...
typedef SWIFT_ENUM_NAMED(NSInteger, IPFailureReason, "FailureReason", open) {
  ...
  IPFailureReasonFaceTooFar = 5,
  IPFailureReasonFaceTooClose = 6,
  IPFailureReasonSunglasses = 7,
  IPFailureReasonSystemError = 8,
  IPFailureReasonLightingIssues = 9,
  IPFailureReasonFaceNotFound = 10,
  IPFailureReasonTimeout = 11,
  IPFailureReasonEyewear = 12,
  IPFailureReasonDeviceIssue = 13,
  IPFailureReasonRejected = 14,
  IPFailureReasonBackgroundIssue = 15,
  IPFailureReasonMotionIssue = 16,
  IPFailureReasonDeviceRestart = 17,
  IPFailureReasonFramesBlurry = 18,
  IPFailureReasonUserNotFound = 19,
  IPFailureReasonProcessingFault = 20,
  IPFailureReasonEyesClosed = 21,
  IPFailureReasonMultipleFaces = 22,
  IPFailureReasonObscuredFace = 23,
};
...
+ (IPSession * _Nonnull)launchWithStreamingURL:(NSURL * _Nonnull)streamingURL token:(NSString * _Nonnull)token options:(IPOptions * _Nonnull)options connecting:(void (^ _Nonnull)(void))connecting connected:(void (^ _Nonnull)(void))connected processing:(void (^ _Nonnull)(double, NSString * _Nonnull))processing success:(void (^ _Nonnull)(IPSuccessResult * _Nonnull))success canceled:(void (^ _Nonnull)(enum IPCanceler))canceled failure:(void (^ _Nonnull)(NSArray<NSString *> * _Nonnull, NSArray<NSString *> * _Nonnull, UIImage * _Nullable))failure error:(void (^ _Nonnull)(NSError * _Nonnull))error SWIFT_WARN_UNUSED_RESULT;
@end
